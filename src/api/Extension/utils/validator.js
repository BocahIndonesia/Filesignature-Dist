...
function validateCommonDataSchema(data) {
    try {
        ...
        if (e instanceof zod_1.ZodError)
            throw new BadRequestError_1.default('Informasi yang dicantumkan untuk membuat Extension harus lengkap dan valid.', (0, zodIssuesMapper_1.default)(e.issues));
        throw (e);
    }
}
...
exports.DataUpdateSchema = zod_1.z.object({
    ...
    mime_id: zod_1.z.number().gt(0).optional()
});
function validateDataUpdateSchema(data) {
    try {
        ...
        if (e instanceof zod_1.ZodError)
            throw new BadRequestError_1.default('Informasi yang dicantumkan untuk update Extension harus valid.', (0, zodIssuesMapper_1.default)(e.issues));
        throw (e);
    }
}
