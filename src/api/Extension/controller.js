...
class default_1 {
    constructor() {
        this.service = clients_1.default.prisma.extension;
    }
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const [pagination, page] = (0, general_1.extractPagination)(req.query);
            const extensions = yield this.service.findMany({
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (exists !== null)
                throw new BadRequestError_1.default(`Extension: ${data.name} telah ada di database.`);
            const extensions = yield this.service.create({ data });
            res.status(201).json({
                status: 'success',
                data: extensions
            });
    ...
    findWhereId(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.params.id === undefined)
                throw new NotFoundError_1.default('Id dari Extension harus dicantumkan di URL.');
            const id = +req.params.id;
            try {
                const extensions = yield this.service.findUniqueOrThrow({ where: { id } });
                res.json({
                    status: 'success',
                    data: extensions
                });
                ...
                throw new NotFoundError_1.default(`Extension dengan id: ${id} tidak ada di database`);
            }
        });
    }
