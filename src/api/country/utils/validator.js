...
function validateCommonDataSchema(data) {
    try {
        ...
        if (e instanceof zod_1.ZodError)
            throw new BadRequestError_1.default('Informasi yang dicantumkan untuk membuat Country harus lengkap dan valid.', (0, zodIssuesMapper_1.default)(e.issues));
        throw (e);
    }
}
...
function validateDataUpdateSchema(data) {
    try {
        ...
        if (e instanceof zod_1.ZodError)
            throw new BadRequestError_1.default('Informasi yang dicantumkan untuk update Country harus valid.', (0, zodIssuesMapper_1.default)(e.issues));
        throw (e);
    }
}
